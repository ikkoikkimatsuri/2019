...
import mapPicture from "../assets/images/map.jpg";
    ...
    <div className="nine columns main-col">
      <div className="row item">
        <div className="twelve columns">
          <h5><span>お車でお越しの方</span></h5>
          <p>北陸自動車道小松ICから県道25号線を南へ約2km、県道20号線を東へ約3km、国道360号を東へ約19km、約40分</p>
          ...
          <div className="columns image-item"><div className="item-wrap"><img alt="" src={mapPicture} /></div></div>
